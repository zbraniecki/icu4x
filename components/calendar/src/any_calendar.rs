...
impl AnyCalendarKind {
    ...
    pub fn as_bcp47_value(self) -> Value {
        match self {
            ...
            AnyCalendarKind::IslamicCivil => Value::try_from_utf8(b"islamic-civil").unwrap(),
            AnyCalendarKind::IslamicObservational => value!("islamic"),
            AnyCalendarKind::IslamicTabular => Value::try_from_utf8(b"islamic-tbla").unwrap(),
            AnyCalendarKind::IslamicUmmAlQura => Value::try_from_utf8(b"islamic-umalqura").unwrap(),
